...
<section id="home" class="relative pt-32 pb-20 px-6 overflow-hidden">
    ...
    <!-- Contact Section -->
    <section id="contact" class="py-20 px-6 bg-gradient-to-b from-[#0b1120] to-[#111827]">
        <div class="container mx-auto">
    ...
    <a href="https://wa.me/<?php echo WA_NUMBER; ?>?text=Halo%20FrameKlip!%20Saya%20mau%20tanya%20tentang%20layanan%20editing%20video" 
       target="_blank"
       class="fixed bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white w-16 h-16 rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transform transition-transform duration-300 ease-out drop-shadow-[0_0_10px_rgba(37,211,102,0.8)] hover:drop-shadow-[0_0_20px_rgba(37,211,102,1)] z-50"
